...
<html lang="en">
  ...
  </a href="{{url('/homebill/view')}}"> <button type="button" id="btn" class="btn btn-primary">View</button></a>
        ...
        <tbody>
          @foreach ($homeBills as $items)
            <tr>
                ...
                <td>
                  <a href="{{url("/homebill/pdelete")}}/{{$items->id}}"><button class="btn btn-danger" id="btn2">Delete</button></a>
                </td>
               <td>
                  <a href="{{url("/homebill/restore")}}/{{$items->id}}"><button class="btn btn-primary" id="btn2">Restore</button>
                  </td>
